...
window.APP_DATA = {
  ...
  warmups: {
    ...
    gymSplit: {
      ...
      color: "grad-gymsplit",
      dayLabels: {
        Monday:    "Monday — Chest + Biceps 🫁💪",
        Tuesday:   "Tuesday — Back + Triceps 🦾🔱",
        Wednesday: "Wednesday — Legs + Shoulders 🦵🏋️",
        Thursday:  "Thursday — Chest + Triceps 🫁🔱",
        Friday:    "Friday — Back + Biceps 🦾💪",
        Saturday:  "Saturday — Legs + Shoulders 🦵🏋️",
      },
      days: {

        // ── MONDAY — CHEST + BICEPS ────────────────────────────────────
        // Science basis: Chest presses don't recruit biceps as a mover
        // (they're antagonists here), so biceps arrive completely fresh.
        // Pairing chest + biceps = zero interference + max quality for both.
        // Jeff Nippard, RP Strength, Barbell Medicine all endorse this pairing.
        // Volume: 16–18 sets chest/wk (split Mon+Thu), 12–14 sets biceps/wk.
        Monday: [
          { name:"Flat Barbell Bench Press",    sets:4, reps:"6–8 reps",   _section:"main", desc:"Grip slightly wider than shoulder-width. Lower bar to mid-chest with 3-sec eccentric. Press explosively. Feet flat, slight arch, shoulder blades pinched. The single best chest mass builder — heavy compound first when CNS is fresh. Add weight each session (progressive overload). RPE 8.", image:"", demo:"https://www.youtube.com/results?search_query=flat+barbell+bench+press+form+hypertrophy" },
          { name:"Incline Dumbbell Press",      sets:4, reps:"10–12 reps", _section:"main", desc:"Bench at 30–45°. Controls both arms independently — fixes left/right imbalances. Incline angle maximally recruits upper pec (clavicular head) which is under-developed in most lifters. 3 sec down, pause at stretch, press. RPE 8–9.", image:"", demo:"https://www.youtube.com/results?search_query=incline+dumbbell+press+upper+chest+form" },
          { name:"Cable Chest Fly (Low-to-High)", sets:3, reps:"12–15 reps", _section:"main", desc:"Cables set at hip height, pull handles up and across in arc. The low-to-high angle is the only exercise that fully activates the upper chest fibres through their full adduction arc. Unlike dumbbells, cables maintain constant tension through the entire rep. Squeeze hard at midline. RPE 8.", image:"", demo:"https://www.youtube.com/results?search_query=low+to+high+cable+fly+upper+chest" },
          { name:"Chest Dips",                  sets:3, reps:"10–12 reps", _section:"main", desc:"Lean torso 30° forward — this shifts load from triceps to lower chest. Lower until elbows reach 90°, feeling a deep pec stretch. Press up through the chest, not the arms. Add weight with dip belt if bodyweight feels too easy. One of the best lower-chest movements.", image:"", demo:"https://www.youtube.com/results?search_query=chest+dips+lean+forward+form" },
          { name:"EZ Bar Curl",                 sets:4, reps:"8–10 reps",  _section:"main", desc:"The EZ bar reduces wrist strain while maintaining bicep tension. Stand tall, elbows pinned at sides. Curl to peak contraction — squeeze hard. Lower in 3 full seconds. The semi-supinated grip hits both the long and short head of the bicep. Add weight each week.", image:"", demo:"https://www.youtube.com/results?search_query=ez+bar+curl+form+biceps" },
          { name:"Incline Dumbbell Curl",       sets:3, reps:"10–12 reps", _section:"main", desc:"Sit on a 45–60° incline bench, arms hang straight down behind body. This creates a massive stretch on the bicep's long head at the bottom — a position that generates the most hypertrophic stimulus. Curl without swinging. Proven superior for long head development (Preacher / Scott variation).", image:"", demo:"https://www.youtube.com/results?search_query=incline+dumbbell+curl+long+head+bicep" },
          { name:"Hammer Curl",                 sets:3, reps:"12–15 reps", _section:"main", desc:"Neutral grip (thumbs up) throughout — targets the brachialis (under the bicep, pushes it up for visible peak) and brachioradialis. Thicker arms through the neutral plane. Alternate arms or do both together. Control the descent — 2 sec down. Finishing volume for arms.", image:"", demo:"https://www.youtube.com/results?search_query=hammer+curl+brachialis+form" },
        ],

        // ── TUESDAY — BACK + TRICEPS ───────────────────────────────────
        // Science basis: Rows and pulldowns don't recruit triceps (elbow
        // extension isn't needed in pulls). Triceps arrive completely fresh.
        // After chest day, triceps got indirect work — now direct volume
        // completes their weekly total. Back also benefits from being paired
        // with a non-competing muscle group.
        Tuesday: [
          { name:"Deadlift",                    sets:4, reps:"5–6 reps",   _section:"main", desc:"The king of all back exercises. Feet hip-width, bar over mid-foot. Push the floor away — don't pull up. Bar stays touching legs all the way up. Lockout by driving hips forward, not hyperextending back. Trains the entire posterior chain (erectors, traps, rhomboids, lats, glutes, hamstrings). RPE 8 — leave 1–2 reps in reserve. Never train deadlifts to failure.", image:"", demo:"https://www.youtube.com/results?search_query=deadlift+form+complete+guide+hypertrophy" },
          { name:"Pull-Ups / Weighted Pull-Ups", sets:4, reps:"8–10 reps", _section:"main", desc:"Wide overhand grip — the bar should touch upper chest at the top. Full dead hang between reps. This is the most complete lat exercise available. Add weight with a belt when bodyweight feels easy. Can substitute with lat pulldown on a cable machine if pull-ups aren't yet possible — same movement pattern, same muscles.", image:"", demo:"https://www.youtube.com/results?search_query=pull+ups+lat+width+form+weighted" },
          { name:"Chest-Supported Row",         sets:4, reps:"10–12 reps", _section:"main", desc:"Lie face down on incline bench. This position completely removes lower back involvement — all tension goes to the mid-back. Pull dumbbells/barbell to hip level, elbows flared 45°. Squeeze shoulder blades at the top for 1 second. Jeff Nippard's top pick for back thickness. Fully stretch at the bottom.", image:"", demo:"https://www.youtube.com/results?search_query=chest+supported+row+form+mid+back" },
          { name:"Seated Cable Row (Close Grip)", sets:3, reps:"12–15 reps", _section:"main", desc:"Close grip V-bar. Sit upright, fully extend arms on each rep (don't shortcut the stretch — it's the eccentric that drives growth). Pull to navel, elbows behind torso. Pause 1 second. Targets the mid-back, lower traps, and teres major. Volume finisher for back thickness.", image:"", demo:"https://www.youtube.com/results?search_query=seated+cable+row+form+back" },
          { name:"Overhead Tricep Extension",   sets:4, reps:"10–12 reps", _section:"main", desc:"Single dumbbell or cable rope overhead. Arms fully extend, then lower weight behind head until 90° bend. This is the ONLY exercise that puts the long head of the tricep in full stretch (long head crosses the shoulder joint) — highest EMG activation of all tricep movements. Research by Kassiano et al. 2023 confirms stretched-position exercises drive more hypertrophy.", image:"", demo:"https://www.youtube.com/results?search_query=overhead+tricep+extension+long+head+stretch" },
          { name:"Close-Grip Bench Press",      sets:3, reps:"8–10 reps",  _section:"main", desc:"Hands 10–12 inches apart on barbell. Lower to lower chest, elbows track backward at 45° (not flared out). Full extension at top — squeeze triceps hard at lockout. The most effective heavy compound movement for overall tricep mass. Triceps are typically under-stimulated by most programs — this fixes it.", image:"", demo:"https://www.youtube.com/results?search_query=close+grip+bench+press+triceps+form" },
          { name:"Cable Pushdown (Rope)",       sets:3, reps:"15–20 reps", _section:"main", desc:"Rope attachment at shoulder height. Separate the rope at the bottom of the rep — this extra range creates a better peak contraction. Elbows stay pinned at sides throughout. Constant cable tension through full ROM unlike dumbbells. High-rep pump finisher. The lateral head responds best to this movement.", image:"", demo:"https://www.youtube.com/results?search_query=cable+rope+pushdown+triceps+form" },
        ],

        // ── WEDNESDAY — LEGS + SHOULDERS ──────────────────────────────
        // Science basis: Legs are the largest muscle group — training them
        // mid-week keeps the split balanced. Shoulder isolation doesn't
        // interfere with any leg movement. Delts are not fatigued by leg work.
        // This avoids the common mistake of training shoulders after chest/back
        // (where they're already pre-fatigued as secondary movers).
        Wednesday: [
          { name:"Barbell Back Squat",          sets:4, reps:"6–8 reps",   _section:"main", desc:"The most anabolic exercise known. Feet shoulder-width, toes 15–30° out. Descend until hip crease is BELOW the knee (full depth) — partial squats underload the glutes and quads. Knee tracks over toe. Neutral spine. Brace core like you're about to be punched. Drive through heels and mid-foot simultaneously. RPE 8.", image:"", demo:"https://www.youtube.com/results?search_query=barbell+back+squat+full+depth+form" },
          { name:"Romanian Deadlift (RDL)",     sets:3, reps:"10–12 reps", _section:"main", desc:"Slight knee bend maintained throughout. Hinge at hips — push them BACK as bar slides down legs. Lower until hamstrings reach full stretch (usually just below knee level for most). Drive hips forward to stand. This is the best hamstring hypertrophy exercise — the stretched position produces superior growth. Do NOT let the lower back round.", image:"", demo:"https://www.youtube.com/results?search_query=romanian+deadlift+hamstring+stretch+form" },
          { name:"Leg Press",                   sets:3, reps:"12–15 reps", _section:"main", desc:"High and wide foot placement targets glutes and hamstrings. Low narrow placement isolates quads. Lower until knees reach 90° — no deeper (protects knees). Press all the way to near-lockout but don't lock out fully. Safer for high-rep quad work after heavy squats. Never let lower back round off the pad.", image:"", demo:"https://www.youtube.com/results?search_query=leg+press+machine+form+quads+glutes" },
          { name:"Walking Lunges",              sets:3, reps:"12 each",   _section:"main", desc:"Hold dumbbells at sides. Step forward, lower until back knee nearly touches floor. Step through — don't step back. 12 reps each leg = 24 total steps. Unilateral loading corrects left-right imbalances, builds glute activation the squat doesn't fully reach. Covers quad, glute, and hamstring in one movement.", image:"", demo:"https://www.youtube.com/results?search_query=walking+lunge+form+dumbbell" },
          { name:"Dumbbell Lateral Raise",      sets:4, reps:"15–20 reps", _section:"main", desc:"The most important shoulder exercise for the aesthetic V-taper look. Slight elbow bend. Raise to shoulder height ONLY — going higher switches load to traps. 2-sec pause at top. 3-sec controlled descent (the eccentric builds more muscle than the lift). Use lighter weight than you think — lateral raise technique breaks down at high loads. Research shows high reps work best here.", image:"", demo:"https://www.youtube.com/results?search_query=dumbbell+lateral+raise+perfect+form+2024" },
          { name:"Cable Lateral Raise",         sets:3, reps:"15–20 reps", _section:"main", desc:"Set cable at ankle height on the opposite side of the working arm. This maintains constant tension at the bottom of the lift — unlike dumbbells which lose tension at the bottom. One arm at a time. Creates the shoulder-width look better than any other variation. Jeff Nippard, Dr Mike Israetel both recommend this as primary lateral raise.", image:"", demo:"https://www.youtube.com/results?search_query=cable+lateral+raise+form+medial+delt" },
          { name:"Leg Curl + Calf Raise",      sets:3, reps:"12 + 20",   _section:"main", desc:"Superset: Lying leg curl (curl heels to glutes, 3-sec eccentric) immediately followed by standing calf raise (full stretch at bottom, 2-sec hold at top). Hamstrings and calves have minimal interference. Efficient finisher. Calves need high volume (20 reps minimum) to respond. Stretch at the bottom of each calf raise is essential.", image:"", demo:"https://www.youtube.com/results?search_query=leg+curl+machine+form+hamstring" },
        ],

        // ── THURSDAY — CHEST + TRICEPS ─────────────────────────────────
        // Science basis: Second chest session this week (hitting each muscle
        // 2×/week is proven superior to 1×/week — Schoenfeld 2016 meta-analysis).
        // Chest press movements also secondarily work the triceps, making this
        // the most logical direct pairing. Brad Schoenfeld, Jeff Nippard both
        // recommend this as the most synergistic pairing for push muscles.
        Thursday: [
          { name:"Dumbbell Bench Press",        sets:4, reps:"10–12 reps", _section:"main", desc:"Greater ROM than barbell (arms can travel further at the bottom — deeper chest stretch). Each arm works independently, correcting imbalances. Control the descent — 3 sec down, pause at bottom stretch, explode up. Primary mass builder on second chest day. Change from Monday's barbell to prevent adaptation.", image:"", demo:"https://www.youtube.com/results?search_query=dumbbell+bench+press+form+full+range" },
          { name:"Incline Barbell Press",       sets:4, reps:"8–10 reps",  _section:"main", desc:"30–45° bench angle. Upper chest is typically the most underdeveloped area — hitting it twice per week with different angles produces visible improvements in 8–12 weeks. Slightly narrower grip than flat bench. Keep elbows at 75° (not flared). This is your main strength movement for Thursday.", image:"", demo:"https://www.youtube.com/results?search_query=incline+barbell+bench+press+form" },
          { name:"Pec Deck / Cable Fly",        sets:3, reps:"15–20 reps", _section:"main", desc:"Pec deck machine OR cable fly at shoulder height. The stretched position of a fly creates maximum mechanical tension on the pec fibres — the most hypertrophic stimulus. Recent research (Kassiano 2023, Wolf 2024) confirms stretched-position exercises outperform shortened-position for pec growth. Feel the full stretch before squeezing closed.", image:"", demo:"https://www.youtube.com/results?search_query=pec+deck+fly+machine+chest+stretch" },
          { name:"EZ Bar Skull Crusher",        sets:4, reps:"10–12 reps", _section:"main", desc:"Lie on flat bench. Lower EZ bar behind head (not to forehead — the behind-head version creates greater stretch on the long head). Keep upper arms pointing straight up at all times. The long head of the tricep makes up 2/3 of the muscle's mass — stretch-position training is critical. Loaded eccentric: 3 sec down.", image:"", demo:"https://www.youtube.com/results?search_query=skull+crusher+behind+head+long+head+tricep" },
          { name:"Tricep Dips (Upright)",       sets:3, reps:"12–15 reps", _section:"main", desc:"Parallel bars, torso UPRIGHT (90° — not leaning like chest dips). This maximally loads the lateral and medial heads of the tricep. Lower until elbows reach 90°. Full extension at top, squeeze triceps at lockout. Add weight with dip belt once bodyweight is easy. Compound movement, allows heavy loading.", image:"", demo:"https://www.youtube.com/results?search_query=tricep+dips+upright+torso+form" },
          { name:"Single-Arm Pushdown",         sets:3, reps:"15–20 each", _section:"main", desc:"Cable at shoulder height, one arm at a time. Unilateral loading ensures both arms do equal work (bilateral deficit means you do more total work). Rotate wrist to pronate at the bottom for peak contraction. The isolation finisher that pumps the lateral head completely. Use the stretch version — don't rush reps.", image:"", demo:"https://www.youtube.com/results?search_query=single+arm+cable+pushdown+tricep" },
          { name:"Diamond Push-Ups — Burnout",  sets:2, reps:"Max reps",   _section:"main", desc:"Hands in diamond shape under sternum, elbows track back along ribs. Go to failure on both sets. This bodyweight finisher flushes blood into all three tricep heads simultaneously and creates a deep pump that signals muscle growth. No equipment, maximal stimulus.", image:"", demo:"https://www.youtube.com/results?search_query=diamond+push+ups+triceps+form" },
        ],

        // ── FRIDAY — BACK + BICEPS ─────────────────────────────────────
        // Science basis: Second back session (2×/week frequency).
        // Back and biceps is the classic "pull day" pairing — back exercises
        // (rows, pulldowns) do recruit biceps as secondary movers, so you
        // finish the session with dedicated bicep work when they're already
        // pre-pumped (but not pre-fatigued to failure). Arnold's favourite
        // training pairing. Backed by research on pre-exhaustion benefits.
        Friday: [
          { name:"Weighted Pull-Ups / Lat Pulldown", sets:4, reps:"8–10 reps", _section:"main", desc:"Second weekly lat session. Wide grip for width, narrow grip for thickness. At the top, bar or chest should touch the bar — no half reps. Full dead hang each rep for complete stretch. For lat width: think about pulling your elbows down and back into your hip pockets, not pulling the bar to you. Add weight or use bands as needed.", image:"", demo:"https://www.youtube.com/results?search_query=weighted+pull+ups+lat+width+full+rom" },
          { name:"Barbell Bent-Over Row",        sets:4, reps:"8–10 reps",  _section:"main", desc:"Hinge until torso is nearly parallel to floor — don't cheat by raising torso. Pull bar to lower chest/upper abs. Elbows stay close to body (45° out for lats, straight back for mid-back). Squeeze shoulder blades hard at the top. This is the most effective back thickness builder available in a gym.", image:"", demo:"https://www.youtube.com/results?search_query=barbell+bent+over+row+form+back+thickness" },
          { name:"Single-Arm DB Row",            sets:3, reps:"12 each",   _section:"main", desc:"Knee on bench, pull dumbbell to hip — elbow should travel PAST the torso for full ROM. Use a heavier weight than feels comfortable — grip the dumbbell loosely to reduce forearm fatigue and keep focus on the lat. Unilateral movement allows the heaviest relative loading of any back exercise per arm.", image:"", demo:"https://www.youtube.com/results?search_query=single+arm+dumbbell+row+full+range" },
          { name:"Face Pull (Rear Delt Focus)",  sets:3, reps:"15–20 reps", _section:"main", desc:"Cable at face height, rope attachment. Pull rope to face with elbows high and flared outward. External rotation at the end of the rep. Targets posterior deltoid and external rotators — the most under-trained muscles in most programs. Essential for shoulder health, posture correction, and balanced physique. Cannot be replaced.", image:"", demo:"https://www.youtube.com/results?search_query=face+pull+rear+delt+external+rotation+form" },
          { name:"Barbell Curl",                 sets:4, reps:"8–10 reps",  _section:"main", desc:"Standing barbell curl — the most loading-efficient bicep exercise. Standard grip (shoulder-width). Control the eccentric fully — 3 sec down. This is your heavy compound bicep movement on Friday. Because back work pre-activated the biceps, peak contraction is often felt more intensely. Add weight progressively.", image:"", demo:"https://www.youtube.com/results?search_query=barbell+curl+form+bicep+strength" },
          { name:"Preacher Curl",                sets:3, reps:"10–12 reps", _section:"main", desc:"Arm rests on preacher pad — completely eliminates body swing. The short head of the bicep is maximally stretched at the bottom. Highest EMG study rating for bicep isolation. Use EZ bar or dumbbell. Lower all the way to full extension — don't shortcut the stretch. Squeeze hard for 1 second at peak.", image:"", demo:"https://www.youtube.com/results?search_query=preacher+curl+form+bicep+peak" },
          { name:"Concentration Curl",           sets:3, reps:"12–15 each", _section:"main", desc:"Seated, elbow on inner thigh. Fully supinate the wrist as you curl (palm rotates fully upward at top). Squeeze for 2 seconds at peak. Highest bicep peak activation of any exercise in EMG studies (ACE 2014). The supination angle is what builds the visible 'peak' on top of the bicep. Finish with all blood in the bicep.", image:"", demo:"https://www.youtube.com/results?search_query=concentration+curl+form+bicep+peak+emg" },
        ],

        // ── SATURDAY — LEGS + SHOULDERS ────────────────────────────────
        // Science basis: Second leg session (quads/glutes 2×/week — essential
        // for maximum hypertrophy in the largest muscle group). Different
        // exercises from Wednesday to provide novel stimulus. Rear delts and
        // overhead press get their second stimulus. Rear delts are chronically
        // under-trained — two sessions per week corrects this.
        Saturday: [
          { name:"Front Squat",                 sets:4, reps:"8–10 reps",  _section:"main", desc:"More upright torso than back squat — maximally loads the quads vs glutes. Bar rests on front delts, elbows as high as possible. Demands more core and upper back stability. The different loading angle creates novel quad stimulus vs Wednesday's back squat — essential for complete leg development.", image:"", demo:"https://www.youtube.com/results?search_query=front+squat+form+quad+dominant" },
          { name:"Bulgarian Split Squat",       sets:3, reps:"10–12 each", _section:"main", desc:"Rear foot elevated on bench or box. Descend until front thigh is parallel to floor. This is the best unilateral leg exercise. Studies show it produces similar or greater quad and glute hypertrophy as bilateral squats, with less spinal loading. Holding dumbbells is fine — allows natural hip position. Fixes all left-right imbalances.", image:"", demo:"https://www.youtube.com/results?search_query=bulgarian+split+squat+form+2024" },
          { name:"Leg Extension",               sets:3, reps:"15–20 reps", _section:"main", desc:"Full ROM — start from complete extension of the knee (not from bent position). Lower all the way at the bottom. Recent research (Pedrosa 2022) shows leg extensions in the lengthened (bottom) position produce nearly 3× more quad hypertrophy than shortened-position machines. Slow, controlled eccentric — 3 sec down.", image:"", demo:"https://www.youtube.com/results?search_query=leg+extension+machine+full+rom+hypertrophy" },
          { name:"Barbell Hip Thrust",          sets:4, reps:"10–15 reps", _section:"main", desc:"Bench at upper-back level. Bar across hips (use pad). Drive hips up until body is horizontal — squeeze glutes HARD at the top for 2 seconds. Glutes are maximally activated at hip extension, not at the stretched bottom position. The best exercise for glute hypertrophy by EMG measures. Essential for athletic performance and hip shape.", image:"", demo:"https://www.youtube.com/results?search_query=barbell+hip+thrust+glute+form" },
          { name:"Dumbbell Shoulder Press",     sets:4, reps:"10–12 reps", _section:"main", desc:"Seated or standing. Full range — start with dumbbells at ear height (don't shortcut the stretch), press to full extension overhead. Dumbbells allow natural wrist rotation, reducing shoulder impingement vs barbell. Works all three deltoid heads. Heavy compound movement for shoulder size and strength. Progress load weekly.", image:"", demo:"https://www.youtube.com/results?search_query=dumbbell+shoulder+press+full+range+form" },
          { name:"Arnold Press",                sets:3, reps:"12–15 reps", _section:"main", desc:"Start dumbbells at chin level, palms facing you. As you press overhead, rotate palms outward — at full extension palms face away from you. Arnold Schwarzenegger's invention specifically targets all three deltoid heads through rotation. Superior to standard press for complete shoulder development. Control the rotation on the way down.", image:"", demo:"https://www.youtube.com/results?search_query=arnold+press+form+all+deltoid+heads" },
          { name:"Reverse Pec Deck / Bent-Over Rear Delt Fly", sets:3, reps:"15–20 reps", _section:"main", desc:"Machine: reverse pec deck with elbows at shoulder height, palms facing down. No machine: hinge forward 45°, dumbbells hanging, raise arms like wings. The rear delt is the most under-trained muscle in most physiques and directly responsible for the '3D shoulder' look. Train 15–20 reps, 2 sessions/week. Never skip this.", image:"", demo:"https://www.youtube.com/results?search_query=reverse+pec+deck+rear+delt+form" },
        ],
    ...
    stretching: {
      ...
      color: "grad-stretch",
      // ── BODY-PART MODE ─────────────────────────────────────────────
      // Stretching is organised by body part, not by weekday.
      // The `bodyParts` array drives the horizontal strip on the module page
      // and the admin editor. Each entry's `id` is the key under `days` below
      // (we keep the `days` key for storage/sync compatibility).
      usesBodyParts: true,
      bodyParts: [
        { id:"neck",       name:"Neck",            emoji:"🦒" },
        { id:"shoulders",  name:"Shoulders",       emoji:"🤲" },
        { id:"chest",      name:"Chest",           emoji:"🫁" },
        { id:"upperBack",  name:"Upper Back",      emoji:"🔼" },
        { id:"lowerBack",  name:"Lower Back",      emoji:"🔽" },
        { id:"hips",       name:"Hips",            emoji:"🦴" },
        { id:"glutes",     name:"Glutes",          emoji:"🍑" },
        { id:"hamstrings", name:"Hamstrings",      emoji:"🦵" },
        { id:"quads",      name:"Quads",           emoji:"🦿" },
        { id:"calves",     name:"Calves & Ankles", emoji:"👣" },
      ],
      days: {
        // ── NECK ─────────────────────────────────────────────────────
neck: [
          { name:"Neck Rolls",                 hold:"5 each dir",  rounds:2, desc:"Stand tall. Drop chin to chest and slowly roll head in full circles — never force, never crank back. Reverse direction after 5 rolls.", image:"🦒", demo:"https://www.youtube.com/results?search_query=neck+rolls+stretch+proper+form" },
          { name:"Neck Rotations",             hold:"5 each side", rounds:2, desc:"Sit tall. Slowly turn head to look over right shoulder, hold 3 sec, return through center, turn left. Keep chin level — no tilting.", image:"🦒", demo:"https://www.youtube.com/results?search_query=neck+rotation+stretch" },
          { name:"Chin Tucks",                 hold:"5 sec hold",  rounds:10, desc:"Sit tall. Glide chin straight back (double-chin position) — don't tilt head down. Strengthens deep neck flexors. Best fix for forward-head posture.", image:"🦒", demo:"https://www.youtube.com/results?search_query=chin+tuck+exercise+posture" },
          { name:"Neck Extension (Controlled)", hold:"5 sec hold", rounds:8, desc:"Slowly look up at the ceiling, mouth closed, jaw relaxed. Hold 5 sec, return. Do NOT crunch the back of neck — go only as far as is comfortable.", image:"🦒", demo:"https://www.youtube.com/results?search_query=neck+extension+exercise" },
          { name:"Side Neck Stretch (Lateral Flexion)", hold:"30 sec each", rounds:2, desc:"Tilt right ear toward right shoulder. Place right hand on top of head — let arm weight (don't pull) deepen the stretch. Opposite shoulder stays down. Switch.", image:"🦒", demo:"https://www.youtube.com/results?search_query=side+neck+stretch+lateral+flexion" },
          { name:"Neck Flexion (Chin to Chest)", hold:"30 sec", rounds:2, desc:"Sit tall. Clasp hands behind head. Let head fall forward — arm weight gently increases stretch. Feel it down the back of neck and upper spine.", image:"🦒", demo:"https://www.youtube.com/results?search_query=neck+flexion+stretch" },
          { name:"Upper Trap Stretch",         hold:"30 sec each", rounds:2, desc:"Sit on right hand (palm under thigh) to anchor shoulder. Left hand on head, tilt left ear down and slightly forward. Feel stretch along the side of neck into trap.", image:"🦒", demo:"https://www.youtube.com/results?search_query=upper+trap+stretch+desk" },
          { name:"Levator Scapulae Stretch",   hold:"30 sec each", rounds:2, desc:"Turn head 45° to right (look at right armpit). Gently bring chin down. Left hand on top of head guides — don't pull hard. Targets the muscle that often causes neck-shoulder pain.", image:"🦒", demo:"https://www.youtube.com/results?search_query=levator+scapulae+stretch" },
          { name:"Sternocleidomastoid (SCM) Stretch", hold:"20 sec each", rounds:2, desc:"Tilt head back slightly and rotate to right. Place left fingers just below right collarbone, lightly pull skin down. Opens the long muscle on side of neck.", image:"🦒", demo:"https://www.youtube.com/results?search_query=SCM+sternocleidomastoid+stretch" },
          { name:"Suboccipital Release",       hold:"60 sec", rounds:1, desc:"Place both thumbs at the base of skull where it meets the spine. Press in and slowly tilt head back into thumbs. Releases tension headaches from screen time.", image:"🦒", demo:"https://www.youtube.com/results?search_query=suboccipital+release+self+massage" },
        ],

        // ── SHOULDERS ────────────────────────────────────────────────
shoulders: [
          { name:"Shoulder Rolls",              hold:"10 each dir", rounds:2, desc:"Stand tall, arms relaxed. Roll shoulders forward in big slow circles for 10 reps. Reverse direction. Warms up rotator cuff and traps.", image:"🤲", demo:"https://www.youtube.com/results?search_query=shoulder+rolls+warmup" },
          { name:"Arm Circles (Small to Large)", hold:"15 each dir", rounds:2, desc:"Arms out to sides at shoulder height. Start with tiny circles, gradually grow to full-arm circles. 15 forward, 15 backward. Loosens entire shoulder girdle.", image:"🤲", demo:"https://www.youtube.com/results?search_query=arm+circles+shoulder+mobility" },
          { name:"Wall Angels",                 hold:"10 reps",     rounds:2, desc:"Stand back against wall, feet 6\" out. Arms in goalpost (90°) against wall. Slide arms up overhead, then down — keep wrists/elbows touching wall. Hard but golden for posture.", image:"🤲", demo:"https://www.youtube.com/results?search_query=wall+angels+exercise" },
          { name:"Cross-Body Shoulder Stretch", hold:"30 sec each", rounds:2, desc:"Pull right arm across chest with left hand at the elbow (not the wrist). Keep right shoulder pulled down — don't shrug. Feel it in the back of the shoulder.", image:"🤲", demo:"https://www.youtube.com/results?search_query=cross+body+shoulder+stretch" },
          { name:"Anterior Shoulder Stretch (Hands Clasped Behind)", hold:"30 sec", rounds:2, desc:"Stand tall. Clasp hands behind your lower back, straighten arms, squeeze shoulder blades together. Lift hands away from body slightly — opens chest and front of shoulders.", image:"🤲", demo:"https://www.youtube.com/results?search_query=anterior+shoulder+stretch+behind+back" },
          { name:"Eagle Arms",                  hold:"30 sec each", rounds:2, desc:"Right arm under left, wrap forearms, press palms together (or back of hands). Lift elbows to shoulder height. Deep stretch across upper back and rear delts. Switch.", image:"🤲", demo:"https://www.youtube.com/results?search_query=eagle+arms+stretch+yoga" },
          { name:"Doorway Shoulder Stretch",   hold:"30 sec each", rounds:2, desc:"Stand in a doorway. Place right forearm on the frame, elbow at 90°. Step left foot forward and lean — opens the front of the shoulder and chest.", image:"🤲", demo:"https://www.youtube.com/results?search_query=doorway+shoulder+stretch" },
          { name:"Behind-Back Arm Reach (Cow Face Arms)", hold:"30 sec each", rounds:2, desc:"Reach right hand up and over the shoulder, down between shoulder blades. Reach left hand behind back, up. Try to clasp fingers (or hold a shirt edge). Switch sides.", image:"🤲", demo:"https://www.youtube.com/results?search_query=cow+face+arms+gomukhasana" },
          { name:"Sleeper Stretch",             hold:"30 sec each", rounds:2, desc:"Lie on right side. Right arm straight out, elbow bent to 90° (forearm up). Use left hand to gently press right forearm toward floor. Targets internal rotation — great for overhead athletes.", image:"🤲", demo:"https://www.youtube.com/results?search_query=sleeper+stretch+shoulder" },
          { name:"Wall Pec/Shoulder Corner Stretch", hold:"30 sec each", rounds:2, desc:"Stand facing a wall corner. Place right palm on wall at shoulder height, arm straight back. Slowly rotate body left away from arm. Stretches anterior delt + biceps + pec.", image:"🤲", demo:"https://www.youtube.com/results?search_query=wall+shoulder+stretch+rotation" },
        ],

        // ── CHEST ────────────────────────────────────────────────────
chest: [
          { name:"Floor Angels",                  hold:"10 reps",     rounds:2, desc:"Lie on back, knees bent, arms in goalpost on floor. Slide arms overhead while keeping back of hands and elbows on floor. Reverse. Opens chest and trains shoulder mobility.", image:"🫁", demo:"https://www.youtube.com/results?search_query=floor+angels+exercise" },
          { name:"Standing Chest Opener (Hands Clasped)", hold:"45 sec", rounds:2, desc:"Stand tall. Interlace fingers behind your lower back. Straighten elbows and lift hands away from butt, lifting chest and chin up. Squeeze shoulder blades together.", image:"🫁", demo:"https://www.youtube.com/results?search_query=standing+chest+opener+stretch" },
          { name:"Sphinx Pose",                   hold:"60 sec", rounds:2, desc:"Lie face down. Forearms flat on floor, elbows directly under shoulders. Press chest forward, draw shoulders down away from ears. Gentler than cobra — better for tight backs.", image:"🫁", demo:"https://www.youtube.com/results?search_query=sphinx+pose+yoga" },
          { name:"Cobra Pose",                    hold:"30 sec", rounds:3, desc:"Lie face down. Hands flat under shoulders. Press chest off floor, pull shoulders back and down, look slightly up. Hips stay on floor. Opens entire front of body.", image:"🫁", demo:"https://www.youtube.com/results?search_query=cobra+pose+chest+stretch" },
          { name:"Doorway Pec Stretch (Single Arm)", hold:"30 sec each", rounds:2, desc:"Stand in doorway. Place right forearm on door frame, elbow at 90° (shoulder height). Step right foot forward, lean gently. Feel it across right pec. Switch.", image:"🫁", demo:"https://www.youtube.com/results?search_query=doorway+pec+stretch+single+arm" },
          { name:"Wall Pec Stretch (High Hand)",  hold:"30 sec each", rounds:2, desc:"Stand sideways to wall. Place right palm on wall above shoulder height (around 11 o'clock). Step away from wall, rotate body left. Hits upper pec fibers. Switch.", image:"🫁", demo:"https://www.youtube.com/results?search_query=wall+pec+stretch+high" },
          { name:"Lying Chest Cross-Body",         hold:"45 sec each", rounds:2, desc:"Lie on right side. Stack knees, drop left arm out at 90° to side. Slowly rotate torso left, trying to put left shoulder on floor. Knees stay stacked. Opens chest + spine.", image:"🫁", demo:"https://www.youtube.com/results?search_query=open+book+chest+stretch" },
          { name:"Wall Corner Pec Minor Stretch",  hold:"30 sec each", rounds:2, desc:"Find a doorway/corner. Place both forearms on either side of frame, elbows at chest height. Step one foot through and lean — deep stretch through chest and pec minor.", image:"🫁", demo:"https://www.youtube.com/results?search_query=pec+minor+doorway+stretch" },
          { name:"Camel Pose (Knees Down)",       hold:"30 sec", rounds:2, desc:"Kneel, knees hip-width. Hands on lower back, fingers pointing down. Lift chest up and back, squeeze glutes. Only reach for heels if comfortable. Big chest + hip flexor opener.", image:"🫁", demo:"https://www.youtube.com/results?search_query=camel+pose+ustrasana" },
          { name:"Bridge Chest Opener",            hold:"30 sec", rounds:3, desc:"Lie on back, knees bent, feet flat. Lift hips up. Interlace fingers under hips, walk shoulders together to deepen the chest stretch. Hold high bridge.", image:"🫁", demo:"https://www.youtube.com/results?search_query=glute+bridge+chest+opener" },
        ],

        // ── UPPER BACK (THORACIC) ────────────────────────────────────
upperBack: [
          { name:"Cat-Cow Stretch",             hold:"10 reps", rounds:2, desc:"On all fours, wrists under shoulders, knees under hips. Inhale → drop belly, lift chest (cow). Exhale → round spine, tuck chin (cat). Slow and smooth.", image:"🔼", demo:"https://www.youtube.com/results?search_query=cat+cow+stretch+yoga" },
          { name:"Quadruped T-Spine Rotation",   hold:"10 each side", rounds:2, desc:"On all fours. Place right hand behind head. Rotate right elbow down toward left wrist (round), then up to ceiling (open). Smooth full range.", image:"🔼", demo:"https://www.youtube.com/results?search_query=quadruped+thoracic+rotation" },
          { name:"Open Book Stretch",           hold:"10 each side", rounds:2, desc:"Lie on right side, knees stacked at 90°, arms straight out in front (palms together). Slowly open top arm across body, follow with eyes. Knees stay stacked. Return. Switch sides.", image:"🔼", demo:"https://www.youtube.com/results?search_query=open+book+stretch+thoracic" },
          { name:"Wall Slides (Scapular)",      hold:"10 reps", rounds:2, desc:"Stand back against wall, feet 6\" out. Forearms flat on wall in 'W' shape. Slide arms up overhead to 'Y' while keeping arms in contact with wall. Lower with control. Brutal for tight upper backs.", image:"🔼", demo:"https://www.youtube.com/results?search_query=wall+slides+scapular+mobility" },
          { name:"Standing Lat Side Bend",      hold:"30 sec each", rounds:2, desc:"Stand tall, reach right arm overhead. Grab right wrist with left hand. Side-bend to the left — keep both feet planted, hips facing forward. Feel it down right side. Switch.", image:"🔼", demo:"https://www.youtube.com/results?search_query=standing+side+bend+lat+stretch" },
          { name:"Standing Forward Fold + Arm Hang", hold:"45 sec", rounds:2, desc:"Stand feet hip-width. Hinge forward from hips. Grab opposite elbows and let upper body hang heavy — head, neck, shoulders all relax. Decompresses spine.", image:"🔼", demo:"https://www.youtube.com/results?search_query=ragdoll+pose+forward+fold" },
          { name:"Child's Pose with Side Reach", hold:"30 sec each", rounds:2, desc:"From hands and knees, sit hips back to heels, arms long in front. Walk both hands to the right — feel left side of back/lat open. Hold, walk to left side. Switch.", image:"🔼", demo:"https://www.youtube.com/results?search_query=child+pose+side+stretch+lat" },
          { name:"Seated Spinal Twist",         hold:"45 sec each", rounds:2, desc:"Sit cross-legged. Place right hand on left knee, left hand behind hips. Inhale tall, exhale twist left — gaze over left shoulder. Spine stays long. Switch.", image:"🔼", demo:"https://www.youtube.com/results?search_query=seated+spinal+twist+ardha+matsyendrasana" },
          { name:"Thread the Needle",           hold:"45 sec each", rounds:2, desc:"On all fours. Reach right arm under left, palm up, until right shoulder is on floor. Left arm extends forward. Deep stretch into right upper back. Switch.", image:"🔼", demo:"https://www.youtube.com/results?search_query=thread+the+needle+pose" },
          { name:"Prayer Stretch / Puppy Pose", hold:"45 sec", rounds:2, desc:"Kneel, walk hands far forward, lower chest toward floor — hips stay over knees. Forehead down. Massive opener for upper back, shoulders, lats.", image:"🔼", demo:"https://www.youtube.com/results?search_query=puppy+pose+stretch+yoga" },
        ],

        // ── LOWER BACK ───────────────────────────────────────────────
lowerBack: [
          { name:"Pelvic Tilts",                hold:"10 reps", rounds:2, desc:"Lie on back, knees bent, feet flat. Press lower back firmly into floor (tilt pelvis up). Release. Slow controlled reps. Wakes up deep core and frees lower spine.", image:"🔽", demo:"https://www.youtube.com/results?search_query=pelvic+tilts+exercise" },
          { name:"Cat-Cow (Lower Focus)",       hold:"10 reps", rounds:2, desc:"On all fours. Focus on the pelvic tilt — tail up, belly down (cow); tail tuck, lower-back round (cat). Move slow. Targets lumbar spine specifically.", image:"🔽", demo:"https://www.youtube.com/results?search_query=cat+cow+lower+back" },
          { name:"Knees Side-to-Side",          hold:"10 each side", rounds:2, desc:"Lie on back, knees bent, feet flat, arms in T. Drop both knees together to right (let them go as far as comfortable). Return to center. To the left. Smooth rocking.", image:"🔽", demo:"https://www.youtube.com/results?search_query=windshield+wipers+stretch+back" },
          { name:"Single Knee-to-Chest",        hold:"30 sec each", rounds:2, desc:"Lie on back, both knees bent. Pull right knee to chest with both hands, left foot stays flat on floor. Press lower back gently into floor. Switch.", image:"🔽", demo:"https://www.youtube.com/results?search_query=single+knee+to+chest+stretch" },
          { name:"Double Knee-to-Chest",        hold:"45 sec", rounds:3, desc:"Lie on back. Hug both knees to chest, hold behind thighs (not on top of knees). Rock side-to-side gently for self-massage of lower back.", image:"🔽", demo:"https://www.youtube.com/results?search_query=double+knee+to+chest+stretch" },
          { name:"Child's Pose",                hold:"60 sec", rounds:2, desc:"From hands and knees, sit hips back to heels (big toes touch, knees wide). Arms stretch forward, forehead to floor. The classic lower-back decompressor.", image:"🔽", demo:"https://www.youtube.com/results?search_query=childs+pose+yoga" },
          { name:"Sphinx Pose (Gentle Extension)", hold:"45 sec", rounds:2, desc:"Lie face down. Forearms on floor, elbows under shoulders. Press chest gently up. Light extension counters all-day flexion from sitting. Stop if any lower-back pinching.", image:"🔽", demo:"https://www.youtube.com/results?search_query=sphinx+pose+lower+back" },
          { name:"Supine Spinal Twist",         hold:"45 sec each", rounds:2, desc:"Lie on back, arms out in T-shape. Bend right knee, cross it over to left side of body (try to touch floor). Look right. Both shoulders stay grounded. Switch.", image:"🔽", demo:"https://www.youtube.com/results?search_query=supine+spinal+twist" },
          { name:"Seated Forward Fold (Easy)",  hold:"45 sec", rounds:2, desc:"Sit with legs straight (slight knee bend OK). Hinge from hips, walk hands down legs as far as comfortable. Round upper back to feel stretch in lower back too. Don't force.", image:"🔽", demo:"https://www.youtube.com/results?search_query=seated+forward+fold+paschimottanasana" },
          { name:"Happy Baby Pose",             hold:"45 sec", rounds:2, desc:"Lie on back. Bring knees to chest, then grab outer edges of feet (or shins). Knees pull down toward armpits. Rock side-to-side gently. Releases sacrum and SI joint.", image:"🔽", demo:"https://www.youtube.com/results?search_query=happy+baby+pose+yoga" },
        ],

        // ── HIPS & HIP FLEXORS ───────────────────────────────────────
hips: [
          { name:"Standing Hip Circles",         hold:"10 each dir", rounds:2, desc:"Stand, hands on hips. Make big slow circles with hips — right, back, left, forward. Imagine drawing a big circle with your tailbone. 10 each direction.", image:"🦴", demo:"https://www.youtube.com/results?search_query=hip+circles+mobility+warmup" },
          { name:"Garland Pose (Deep Squat)",    hold:"45 sec", rounds:2, desc:"Feet wider than hips, toes slightly out. Squat down as low as comfortable, heels stay flat if possible. Elbows inside knees, palms together, press knees out.", image:"🦴", demo:"https://www.youtube.com/results?search_query=malasana+yoga+deep+squat" },
          { name:"Low Lunge Hip Flexor Stretch", hold:"45 sec each", rounds:2, desc:"Start in low lunge — right foot forward, left knee on floor. Push hips forward and DOWN (don't lean torso forward). Squeeze left glute. Switch.", image:"🦴", demo:"https://www.youtube.com/results?search_query=low+lunge+hip+flexor+stretch" },
          { name:"Butterfly Stretch",            hold:"60 sec", rounds:2, desc:"Sit, soles of feet together, heels close to groin. Hold ankles. Use elbows to gently press knees toward floor. Hinge forward from hips for deeper stretch.", image:"🦴", demo:"https://www.youtube.com/results?search_query=butterfly+stretch+groin" },
          { name:"Happy Baby Pose",              hold:"45 sec", rounds:2, desc:"Lie on back. Bring knees to chest, grab outer edges of feet. Knees pull toward armpits, shins vertical. Rock side-to-side. Targets inner hips and groin.", image:"🦴", demo:"https://www.youtube.com/results?search_query=happy+baby+hip+opener" },
          { name:"Half-Frog (Bent Knee Drop)",   hold:"45 sec each", rounds:2, desc:"Lie face down. Bend right knee out to side, knee at 90° with thigh out wide. Left leg straight. Hips pressed down. Switch.", image:"🦴", demo:"https://www.youtube.com/results?search_query=half+frog+pose+hip+opener" },
          { name:"90/90 Hip Stretch",            hold:"60 sec each", rounds:2, desc:"Sit on floor. Front leg bent 90° in front of you, back leg bent 90° to side. Sit tall, then hinge forward over the front shin. Switch leg positions.", image:"🦴", demo:"https://www.youtube.com/results?search_query=90+90+hip+stretch+mobility" },
          { name:"Kneeling Hip Flexor Stretch", hold:"45 sec each", rounds:2, desc:"Half-kneeling — right knee down, left foot forward. Tuck pelvis (tilt pubic bone up). Lift right arm overhead, side-bend left for deeper stretch. Switch.", image:"🦴", demo:"https://www.youtube.com/results?search_query=kneeling+hip+flexor+stretch+arm+overhead" },
          { name:"Pigeon Pose",                  hold:"60 sec each", rounds:2, desc:"From all fours, bring right knee toward right wrist, shin angled across. Extend left leg straight back. Square hips. Hinge forward over front leg. Switch.", image:"🦴", demo:"https://www.youtube.com/results?search_query=pigeon+pose+yoga" },
          { name:"Frog Pose",                    hold:"60 sec", rounds:2, desc:"On all fours, slowly widen knees outward (as wide as comfortable). Feet in line with knees. Rock hips forward and back. Deep inner-thigh and groin opener.", image:"🦴", demo:"https://www.youtube.com/results?search_query=frog+pose+yoga+stretch" },
        ],

        // ── GLUTES ───────────────────────────────────────────────────
glutes: [
          { name:"Glute Bridge Hold",            hold:"30 sec hold", rounds:3, desc:"Lie on back, knees bent, feet flat. Press through heels and lift hips up — squeeze glutes hard at top. Don't arch lower back. Hold the bridge.", image:"🍑", demo:"https://www.youtube.com/results?search_query=glute+bridge+hold" },
          { name:"Cross-Body Knee Pull",         hold:"45 sec each", rounds:2, desc:"Lie on back. Bend right knee, then pull it across body toward LEFT shoulder using both hands. Right shoulder stays on floor. Switch.", image:"🍑", demo:"https://www.youtube.com/results?search_query=cross+body+glute+stretch" },
          { name:"Lying Knee-to-Opposite-Shoulder", hold:"30 sec each", rounds:2, desc:"Lie on back, legs straight. Pull right knee toward LEFT shoulder (across body) — keep left leg straight on floor. Targets piriformis. Switch.", image:"🍑", demo:"https://www.youtube.com/results?search_query=piriformis+stretch+knee+opposite+shoulder" },
          { name:"Supine Figure-4 Stretch",      hold:"60 sec each", rounds:2, desc:"Lie on back, knees bent, feet flat. Cross right ankle over left knee (figure-4 shape). Reach through and pull left thigh toward chest. Switch.", image:"🍑", demo:"https://www.youtube.com/results?search_query=supine+figure+4+stretch" },
          { name:"Seated Figure-4 Stretch",      hold:"45 sec each", rounds:2, desc:"Sit on chair or floor. Cross right ankle over left knee. Sit tall, then hinge forward from hips (don't round back). Feel deep right glute stretch. Switch.", image:"🍑", demo:"https://www.youtube.com/results?search_query=seated+figure+4+glute+stretch" },
          { name:"Standing Pigeon at Wall",      hold:"45 sec each", rounds:2, desc:"Stand facing wall, hands on wall. Cross right ankle over left knee (figure-4 standing). Sit hips back as if into a chair. Deep standing glute stretch. Switch.", image:"🍑", demo:"https://www.youtube.com/results?search_query=standing+figure+4+stretch+wall" },
          { name:"Cross-Legged Forward Fold",    hold:"45 sec each side", rounds:2, desc:"Sit cross-legged with right shin in front of left. Sit tall, hinge forward from hips. Walk hands forward. Switch leg position (left in front) and repeat.", image:"🍑", demo:"https://www.youtube.com/results?search_query=cross+legged+forward+fold+glute" },
          { name:"Sleeping Pigeon (Reclined)",   hold:"60 sec each", rounds:2, desc:"Lie on back. Cross right ankle over left thigh (just above knee). Lift left foot off floor, grab behind left thigh, pull toward chest. Deepest glute version of figure-4.", image:"🍑", demo:"https://www.youtube.com/results?search_query=reclined+pigeon+pose+glute" },
          { name:"Pigeon Pose",                  hold:"60 sec each", rounds:2, desc:"From all fours, bring right knee forward toward right wrist, shin across. Back leg long behind. Square hips, hinge forward over front shin to deepen. Switch.", image:"🍑", demo:"https://www.youtube.com/results?search_query=pigeon+pose+glute+stretch" },
          { name:"Pretzel Stretch (Side-Lying)", hold:"45 sec each", rounds:2, desc:"Lie on left side. Bend right knee up toward chest at 90°, then drop right foot across body toward floor behind you while keeping right knee high. Twists hips. Switch.", image:"🍑", demo:"https://www.youtube.com/results?search_query=pretzel+stretch+hip" },
        ],

        // ── HAMSTRINGS ───────────────────────────────────────────────
hamstrings: [
          { name:"Standing Toe Touches (Dynamic)", hold:"15 reps", rounds:2, desc:"Stand tall. Slowly bend forward, reach toward toes (knees can bend slightly). Slowly return to stand. Smooth controlled reps — no bouncing.", image:"🦵", demo:"https://www.youtube.com/results?search_query=standing+toe+touch+dynamic" },
          { name:"Legs Up the Wall (Variation)", hold:"60 sec", rounds:1, desc:"Lie on back with hips close to a wall. Extend legs straight up the wall. Heels touch wall, legs straight. Mild hamstring stretch + drains the legs. Restorative.", image:"🦵", demo:"https://www.youtube.com/results?search_query=legs+up+the+wall+pose" },
          { name:"Supine Hamstring Stretch",     hold:"45 sec each", rounds:2, desc:"Lie on back. Pull right knee to chest, then slowly straighten right leg toward ceiling. Hold behind right thigh or calf (whichever you can reach). Left leg flat. Switch.", image:"🦵", demo:"https://www.youtube.com/results?search_query=supine+hamstring+stretch" },
          { name:"Standing Forward Fold",        hold:"45 sec", rounds:2, desc:"Stand feet hip-width. Hinge from hips, fold forward. Slight bend in knees if hamstrings are tight. Let head and arms hang heavy. Hold elbows for extra.", image:"🦵", demo:"https://www.youtube.com/results?search_query=standing+forward+fold+hamstring" },
          { name:"Single-Leg Forward Fold",      hold:"45 sec each", rounds:2, desc:"Stand. Step right foot 6\" forward, toes up, heel on floor. Hinge over right leg, hands on left thigh for support. Right leg straight. Switch.", image:"🦵", demo:"https://www.youtube.com/results?search_query=single+leg+forward+fold+hamstring" },
          { name:"Seated Forward Fold",          hold:"60 sec", rounds:2, desc:"Sit with legs straight in front, feet flexed. Sit on edge of a folded blanket if hamstrings are tight. Hinge from hips, walk hands forward — don't round back.", image:"🦵", demo:"https://www.youtube.com/results?search_query=seated+forward+fold+paschimottanasana" },
          { name:"Half Splits (Ardha Hanumanasana)", hold:"45 sec each", rounds:2, desc:"Start in low lunge — right foot forward. Straighten right leg, pull hips back toward left heel, foot flexed. Hinge over right leg from hips. Switch.", image:"🦵", demo:"https://www.youtube.com/results?search_query=half+splits+ardha+hanumanasana" },
          { name:"Standing Wide-Leg Forward Fold", hold:"45 sec", rounds:2, desc:"Stand feet 3-4 ft apart, toes parallel. Hinge from hips, fold forward, hands to floor (or shins). Crown of head reaches toward floor. Strong hamstring + inner-thigh.", image:"🦵", demo:"https://www.youtube.com/results?search_query=standing+wide+legged+forward+fold" },
          { name:"Wide-Legged Forward Fold (Pancake)", hold:"60 sec", rounds:2, desc:"Sit with legs as wide as comfortable, feet flexed. Sit tall, then hinge from hips and walk hands forward. Don't round — go as low as comfortable. Bend knees slightly if needed.", image:"🦵", demo:"https://www.youtube.com/results?search_query=pancake+stretch+upavistha+konasana" },
          { name:"PNF Hamstring (Contract-Relax)", hold:"3 cycles each", rounds:1, desc:"Lie on back. Lift right leg as high as you can with hands behind thigh. Contract hamstring (push leg DOWN against hands) 6 sec, relax, pull deeper. 3 cycles. Switch.", image:"🦵", demo:"https://www.youtube.com/results?search_query=PNF+hamstring+stretch+contract+relax" },
        ],

        // ── QUADRICEPS ───────────────────────────────────────────────
quads: [
          { name:"Squat-Heels-Down Hold",        hold:"30 sec", rounds:3, desc:"Deep squat, feet flat. Hands together at chest, press knees out with elbows. Sink hips low. Don't let heels lift. Light quad and big hip stretch.", image:"🦿", demo:"https://www.youtube.com/results?search_query=deep+squat+hold+mobility" },
          { name:"Standing Quad Stretch",        hold:"30 sec each", rounds:2, desc:"Stand on left leg (hold wall for balance). Bend right knee, grab right ankle behind you, pull heel to glute. Knees stay together, push hips slightly forward. Switch.", image:"🦿", demo:"https://www.youtube.com/results?search_query=standing+quad+stretch" },
          { name:"Side-Lying Quad Stretch",      hold:"45 sec each", rounds:2, desc:"Lie on left side. Bend right knee, grab right ankle behind body, pull heel to glute. Keep right knee in line with body — don't let it drift forward. Switch.", image:"🦿", demo:"https://www.youtube.com/results?search_query=side+lying+quad+stretch" },
          { name:"Prone Quad Stretch",           hold:"45 sec each", rounds:2, desc:"Lie face down. Bend right knee, reach back, grab right ankle. Pull heel toward glute. For extra, lift knee slightly off the floor. Switch.", image:"🦿", demo:"https://www.youtube.com/results?search_query=prone+quad+stretch" },
          { name:"Lunging Quad Stretch",         hold:"45 sec each", rounds:2, desc:"Start in low lunge — right foot forward, left knee down. Reach back with left hand, grab left foot/ankle, pull toward glute. Keep torso upright. Switch.", image:"🦿", demo:"https://www.youtube.com/results?search_query=lunge+quad+stretch" },
          { name:"Wall Quad Stretch",            hold:"30 sec each", rounds:2, desc:"Stand facing a wall, about 1 ft away. Bend right knee and place top of right foot against wall behind you. Left leg forward in mini-lunge. Push hips forward. Switch.", image:"🦿", demo:"https://www.youtube.com/results?search_query=wall+quad+stretch" },
          { name:"Kneeling Quad Stretch (Couch Stretch No-Equipment)", hold:"45 sec each", rounds:2, desc:"Kneel facing AWAY from wall. Place right shin against wall (top of foot pointed up). Left foot forward in lunge. Tuck pelvis, lift torso tall. Brutal quad/hip flexor. Switch.", image:"🦿", demo:"https://www.youtube.com/results?search_query=couch+stretch+quad+wall" },
          { name:"Hero's Pose (Virasana)",       hold:"60 sec", rounds:2, desc:"Kneel with knees together, feet wider than hips (tops of feet flat). Sit between heels (or on a pillow if knees hurt). Sit tall. Stretches quads and front of ankles.", image:"🦿", demo:"https://www.youtube.com/results?search_query=hero+pose+virasana" },
          { name:"Pigeon Quad Variation",        hold:"45 sec each", rounds:2, desc:"In pigeon pose (right leg forward), bend left knee behind you and reach back with left hand to grab left foot. Pull foot toward glute. Switch.", image:"🦿", demo:"https://www.youtube.com/results?search_query=mermaid+pose+quad" },
          { name:"Reclining Hero (Modified)",    hold:"45 sec", rounds:2, desc:"From Hero's Pose, slowly lean back onto elbows. Stop if knees hurt. Advanced: lower all the way down onto back. Intense quad stretch — don't force.", image:"🦿", demo:"https://www.youtube.com/results?search_query=reclining+hero+pose+supta+virasana" },
        ],

        // ── CALVES & ANKLES ──────────────────────────────────────────
calves: [
          { name:"Ankle Circles (Seated)",          hold:"10 each dir", rounds:2, desc:"Sit on floor, legs straight. Lift right foot, draw slow controlled circles with foot — 10 clockwise, 10 counter. Switch foot. Improves ankle joint mobility.", image:"👣", demo:"https://www.youtube.com/results?search_query=ankle+circles+mobility" },
          { name:"Seated Toe Flex & Point",         hold:"15 reps", rounds:2, desc:"Sit with legs straight. Point toes hard away (calf squeezes), then flex toes back hard (calf stretches). Slow controlled. 15 reps. Wakes up entire lower leg.", image:"👣", demo:"https://www.youtube.com/results?search_query=ankle+pump+flex+point" },
          { name:"Heel Walks",                      hold:"30 sec", rounds:2, desc:"Walk forward on heels only (toes lifted off floor) for 30 sec. Strengthens shins and stretches calves. Great pre-run warm-up.", image:"👣", demo:"https://www.youtube.com/results?search_query=heel+walk+exercise" },
          { name:"Toe Walks",                       hold:"30 sec", rounds:2, desc:"Walk on the balls of feet (heels off floor) for 30 sec. Strengthens calves and improves ankle stability.", image:"👣", demo:"https://www.youtube.com/results?search_query=toe+walks+exercise" },
          { name:"Downward Dog Calf Pump",          hold:"10 reps", rounds:2, desc:"Get into downward dog. Bend right knee deeply while pressing left heel toward floor. Switch — bend left, push right heel down. Pump back and forth.", image:"👣", demo:"https://www.youtube.com/results?search_query=downward+dog+calf+pedal" },
          { name:"Wall Ankle Mobility Drill",       hold:"10 each side", rounds:2, desc:"Kneel/lunge facing wall, right foot forward (toe ~5\" from wall). Drive right knee FORWARD to touch wall — heel stays glued down. Return. 10 reps. Switch.", image:"👣", demo:"https://www.youtube.com/results?search_query=wall+ankle+mobility+test" },
          { name:"Deep Squat Ankle Drive",          hold:"45 sec", rounds:2, desc:"Drop into a deep squat (heels down). Place hands on right knee and drive knee FORWARD over toes. Don't let heel lift. Switch knees. Improves ankle dorsiflexion.", image:"👣", demo:"https://www.youtube.com/results?search_query=deep+squat+ankle+mobility" },
          { name:"Standing Calf Stretch (Wall)",    hold:"30 sec each", rounds:2, desc:"Face wall, hands on wall. Step right foot back, keep right leg straight, heel down. Bend front knee, lean into wall. Stretches gastrocnemius (upper calf). Switch.", image:"👣", demo:"https://www.youtube.com/results?search_query=standing+calf+stretch+wall" },
          { name:"Soleus Stretch (Bent Knee)",      hold:"30 sec each", rounds:2, desc:"Same setup as standing calf — but BEND the back knee while keeping back heel down. Bent knee shifts stretch from gastroc to soleus (deep lower calf). Switch.", image:"👣", demo:"https://www.youtube.com/results?search_query=soleus+stretch+bent+knee" },
          { name:"Kneeling Toe Stretch",            hold:"30 sec", rounds:2, desc:"Kneel with TOES TUCKED UNDER (balls of feet on floor). Sit back on heels. Intense stretch through toes, arches, plantar fascia. Stop if any sharp pain.", image:"👣", demo:"https://www.youtube.com/results?search_query=kneeling+toe+stretch+plantar+fascia" },
        ],
      }
    },
